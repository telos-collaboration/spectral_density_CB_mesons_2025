...
def mass_extp(wildcards, observables):
    return [
        f"JSONs/extrapolation_results/{observable}_samples.json".format(**row)
        for observable in observables
        for row in metadata.to_dict(orient="records")
...
def chipt_extp(wildcards):
    return [
        f"JSONs/chipt_extrapolation_results/chipt_b{beta}_extp_samples.json"
        for beta in [6.6,6.65,6.7,6.75,6.8]
    ]

def deft_extp(wildcards):
    return [
        f"JSONs/deft_extrapolation_results/deft_b{beta}_extp_samples.json"
        for beta in [6.6,6.65,6.7,6.75,6.8]
    ]
...
rule plot_finite_volume:
    ...
    input:
        ...
        script="plateaus/plots/finite_volume.py"
    output:
...
rule plot_mpsmv_vs_mpcac:
    ...
    input:
        ...
        script="plateaus/plots/mpsmv_vs_mpcac.py"
    output:
...
rule plot_mpsfps_vs_mpcac:
    ...
    input:
        ...
        script="plateaus/plots/mpsfps_vs_mpcac.py"
    output:
...
rule plot_meson_mass_vs_fermion_mass:
    ...
    input:
        ...
        script="plateaus/plots/meson_vs_fermion.py"
    output:
...
rule plot_decay_constant_vs_fermion_mass:
    ...
    input:
        ...
        script="plateaus/plots/decay_vs_fermion.py"
    output:
...
rule plot_meson_mass_fps_vs_mpcac:
    ...
    input:
        ...
        script="plateaus/plots/meson_fps_vs_mpcac.py"
    output:
...
rule plot_mv_vs_mps:
    ...
    input:
        ...
        script="plateaus/plots/mv_vs_mps.py"
    output:
...
rule plot_extrapolations_meson_mass:
    ...
    input:
        ...
        script="plateaus/plots/w0mps_vs_meson.py",
    output:
...
rule plot_extrapolations_meson_decay:
    ...
    input:
        ...
        script="plateaus/plots/w0mps_vs_decay.py",
    output:
...
rule plot_R_mvfps_vs_mps:
    ...
    input:
        ...
        fit_results="JSONs/extrapolation_results/R_mvdfps_extp_samples.json",
        script="plateaus/plots/R_mvfps_vs_mps.py"
    output:
...
rule plot_R_mvprime_dmv_vs_mps:
    ...
    input:
        ...
        script="plateaus/plots/R_mvprime_dmv_vs_mps.py"
    output:
...
rule plot_w0_vs_mps:
    ...
    input:
        ...
        script="plateaus/plots/w0_vs_mps.py"
    output:
...
rule plot_R_mps_dfps_vs_mps:
    ...
    input:
        ...
        script="plateaus/plots/R_mps_dfps_vs_mps.py"
    output:
...
rule plot_chipt:
    ...
    input:
        ...
        script="plateaus/plots/chipt.py"
    output:
