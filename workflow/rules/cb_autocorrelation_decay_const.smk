...
rule mass_wall:
    ...
    conda: "../../CB_autocorrelation_decay_constant/environment.yml"
    shell: f"python {cb_python_source}/mass_wall.py --ensemble_name {wildcards.ensemble_name}/{wildcards.representation} --plateau_start {params.plateau_start} --plateau_end {params.plateau_end} --output_file_mean {output.csv} --channel {wildcards.channel} {input.correlators}"
...
rule comparison_plots:
    ...
    output:
        ...
        comparison_table="assets/tables/local_smeared_decay.tex",
