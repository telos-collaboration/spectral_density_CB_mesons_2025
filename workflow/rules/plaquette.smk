...
rule avg_plaquette:
    ...
    input:
        ...
        script="plateaus/plaquette.py",
    output:
        mean=f"JSONs/{dir_template}/plaquette_mean.csv",
        samples=f"JSONs/{dir_template}/plaquette_samples.json",
    conda:
...
def main_plaquette_data(wildcards):
    return [
        f"JSONs/{dir_template}/plaquette_mean.csv".format(**row)
...
rule tabulate_largevolume_plaquettes:
    ...
    input:
        ...
        script="plateaus/tables/plaquette.py",
    output:
...
rule plot_smallvolume_plaquettes:
    ...
    input:
        ...
        script="plateaus/plaquette_hmc.py",
    output:
