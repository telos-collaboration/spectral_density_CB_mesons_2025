...
file_path = 'spectrum_second_fund.txt'
...
axs[0].set_ylim((0.81,0.97))

# Add a common legend below both subplots
fig.legend(handles=legend_handles, loc='upper center', bbox_to_anchor=(0.5, 0.03), frameon=False, fontsize=13, ncol=4)

# Add a main title for the entire figure
plt.suptitle('$aE_2$ fits, fundamental sector', fontsize=14)

# Adjust layout
plt.tight_layout(rect=[0, 0, 1, 0.96])

# Save the figure in PDF format with dpi=300 and specified size
plt.savefig('../../../plots/nt64_spectrum_second_fund.pdf', dpi=300, bbox_inches='tight')
