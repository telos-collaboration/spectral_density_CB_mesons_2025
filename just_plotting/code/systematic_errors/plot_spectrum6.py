...
file_path = 'spectrum_second_as.txt'
...
plt.suptitle('$aE_2$ fits, antisymmetric sector', fontsize=14)

# Adjust layout
plt.tight_layout(rect=[0, 0, 1, 0.96])

# Save the figure in PDF format with dpi=300 and specified size
plt.savefig('../../../plots/nt64_spectrum_second_as.pdf', dpi=300, bbox_inches='tight')
