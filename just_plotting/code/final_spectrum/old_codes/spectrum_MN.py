...
output_file = '../../plots/final_spectrum_MN.pdf'
...
color7 = cm.Reds(( len(values_ground1) + len(values_first1 ) - 20 + len(values_ground2)+len(values_first2)+len(values_second2)+len(values_first3)) / (len(values_ground1) + len(values_first1) + len(values_ground2) + len(values_first2)+len(values_ground3) + len(values_first3)+len(values_second3)) )
color8 = cm.Reds((len(values_ground1) + len(values_first1) - 5 + len(values_ground2)+len(values_first2)+len(values_second2)+len(values_first3)) / (len(values_ground1) + len(values_first1) + len(values_ground2) + len(values_first2)+len(values_ground3) + len(values_first3)+len(values_second3)) )
...
color9 = cm.Purples(( len(values_ground1) + len(values_first1 ) - 30 + len(values_ground2)+len(values_first2)+len(values_second2)+len(values_first3)) / (len(values_ground1) + len(values_first1) + len(values_ground2) + len(values_first2)+len(values_ground3) + len(values_first3)+len(values_second3)) )
color10 = cm.Purples((len(values_ground1) + len(values_first1) + 5 + len(values_ground2)+len(values_first2)+len(values_second2)+len(values_first3)) / (len(values_ground1) + len(values_first1) + len(values_ground2) + len(values_first2)+len(values_ground3) + len(values_first3)+len(values_second3)) )
...
for i in range(len(values_ground1)):
    if i < 6:
        ...
        color = color4
    ax.add_patch(plt.Rectangle((i - 0.5 + spacing*i +0.2, values_ground1[i] - errors_ground1[i]), 0.4, 2*errors_ground1[i], color=color, alpha=0.7))
...
for i in range(len(values_first1)):
    if i < 6:
        ...
        color = color4
    ax.add_patch(plt.Rectangle((i - 0.5 + spacing*i +0.2, values_first1[i] - errors_first1[i]), 0.4, 2*errors_first1[i], color=color, alpha=0.7))
...
for i in range(len(values_ground2)):
    if i < 6:
        ...
        color = color5
    ax.add_patch(plt.Rectangle((i - 0.4 + spacing*i +0.2, values_ground2[i] - errors_ground2[i]), 0.4, 2*errors_ground2[i], color=color, alpha=0.7))
...
for i in range(len(values_first2)):
    if i < 6:
        ...
        color = color5
    ax.add_patch(plt.Rectangle((i - 0.4 + spacing*i +0.2, values_first2[i] - errors_first2[i]), 0.4, 2*errors_first2[i], color=color, alpha=0.7))
...
for i in range(len(values_second2)):
    if i < 6:
        ...
        color = color5
    ax.add_patch(plt.Rectangle((i - 0.5 + spacing*i +0.2, values_second2[i] - errors_second2[i]), 0.4, 2*errors_second2[i], color=color, alpha=0.7))
...
for i in range(len(values_ground3)):
    if i < 6:
        ...
        color = color6
    ax.add_patch(plt.Rectangle((i - 0.3 + spacing*i +0.2, values_ground3[i] - errors_ground3[i]), 0.4, 2*errors_ground3[i], color=color, alpha=0.7))
...
for i in range(len(values_first3)):
    if i < 6:
        ...
        color = color6
    ax.add_patch(plt.Rectangle((i - 0.3 + spacing*i +0.2, values_first3[i] - errors_first3[i]), 0.4, 2*errors_first3[i], color=color, alpha=0.7))
...
for i in range(len(values_second3)):
    if i < 6:
        ...
        color = color6
    ax.add_patch(plt.Rectangle((i - 0.4 + spacing*i +0.2, values_second3[i] - errors_second3[i]), 0.4, 2*errors_second3[i], color=color, alpha=0.7))
...
for i in range(len(values_ground3)):
    if i < 6:
        ...
        color = color9
    ax.add_patch(plt.Rectangle((i - 0.7 + spacing*i +0.2, values_ground4[i] - errors_ground4[i]), 0.15, 2*errors_ground4[i], color=color, alpha=0.7))
...
for i in range(len(values_first3)):
    if i < 6:
        ...
        color = color9
    ax.add_patch(plt.Rectangle((i - 0.7 + spacing*i +0.2, values_first4[i] - errors_first4[i]), 0.15, 2*errors_first4[i], color=color, alpha=0.7))
...
for i in range(len(values_second3)):
    if i < 6:
        ...
        color = color9
    ax.add_patch(plt.Rectangle((i - 0.7 + spacing*i +0.2, values_second4[i] - errors_second4[i]), 0.15, 2*errors_second4[i], color=color, alpha=0.7))
...
for i in range(len(values_ground3)):
    if i < 6:
        ...
        color = color10
    ax.add_patch(plt.Rectangle((i + 0.15 + spacing*i+0.2, values_ground5[i] - errors_ground5[i]), 0.15, 2*errors_ground5[i], color=color, alpha=0.7))
...
for i in range(len(values_first3)):
    if i < 6:
        ...
        color = color10
    ax.add_patch(plt.Rectangle((i + 0.15 + spacing*i+0.2, values_first5[i] - errors_first5[i]), 0.15, 2*errors_first5[i], color=color, alpha=0.7))
...
for i in range(len(values_second3)):
    if i < 6:
        ...
        color = color10
    ax.add_patch(plt.Rectangle((i + 0.15 + spacing*i+0.2, values_second5[i] - errors_second5[i]), 0.15, 2*errors_second5[i], color=color, alpha=0.7))
...
# Create custom legend handles with color patches for each group
legend_handles = [
    mpatches.Patch(color=color1, alpha=0.7),
    mpatches.Patch(color=color2, alpha=0.7),
    mpatches.Patch(color=color3, alpha=0.7),
    mpatches.Patch(color=color4, alpha=0.7),
    mpatches.Patch(color=color5, alpha=0.7),
    mpatches.Patch(color=color6, alpha=0.7),
    mpatches.Patch(color=color7, alpha=0.7),
    mpatches.Patch(color=color8, alpha=0.7),
    mpatches.Patch(color=color9, alpha=0.7),
    mpatches.Patch(color=color10, alpha=0.7)
]
...
plt.legend([(legend_handles[0], legend_handles[3]), (legend_handles[1], legend_handles[4]), (legend_handles[2],legend_handles[5]), (legend_handles[6], legend_handles[8]), (legend_handles[7],legend_handles[9])], ['M1', 'M2', 'M3', 'M4', 'M5'],
