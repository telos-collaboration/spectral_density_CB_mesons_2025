...
# Build dictionary
w0_values = {
    ens: read_specific_dataset(args.topology_h5, f"{ens}/w0_val") for ens in ensembles
}
...
files = [
    (
        "M1",
        [
            "input_fit/final_spectrum/M1_ground.txt",
            "input_fit/final_spectrum/M1_first.txt",
        ],
    ),
    (
        "M2",
        [
            "input_fit/final_spectrum/M2_ground.txt",
            "input_fit/final_spectrum/M2_first.txt",
            "input_fit/final_spectrum/M2_second.txt",
        ],
    ),
    (
        "M3",
        [
            "input_fit/final_spectrum/M3_ground.txt",
            "input_fit/final_spectrum/M3_first.txt",
            "input_fit/final_spectrum/M3_second.txt",
        ],
    ),
    (
        "M4",
        [
            "input_fit/final_spectrum/M4_ground.txt",
            "input_fit/final_spectrum/M4_first.txt",
            "input_fit/final_spectrum/M4_second.txt",
        ],
    ),
    (
        "M5",
        [
            "input_fit/final_spectrum/M5_ground.txt",
            "input_fit/final_spectrum/M5_first.txt",
            "input_fit/final_spectrum/M5_second.txt",
        ],
    ),
    # CB channels
    (
        "M1",
        [
            "input_fit/final_spectrum/CB_M1_ground.txt",
            "input_fit/final_spectrum/CB_M1_first.txt",
            "input_fit/final_spectrum/CB_M1_second.txt",
        ],
    ),
    (
        "M2",
        [
            "input_fit/final_spectrum/CB_M2_ground.txt",
            "input_fit/final_spectrum/CB_M2_first.txt",
            "input_fit/final_spectrum/CB_M2_second.txt",
        ],
    ),
    (
        "M3",
        [
            "input_fit/final_spectrum/CB_M3_ground.txt",
            "input_fit/final_spectrum/CB_M3_first.txt",
            "input_fit/final_spectrum/CB_M3_second.txt",
        ],
    ),
    (
        "M4",
        [
            "input_fit/final_spectrum/CB_M4_ground.txt",
            "input_fit/final_spectrum/CB_M4_first.txt",
            "input_fit/final_spectrum/CB_M4_second.txt",
        ],
    ),
    (
        "M5",
        [
            "input_fit/final_spectrum/CB_M5_ground.txt",
            "input_fit/final_spectrum/CB_M5_first.txt",
            "input_fit/final_spectrum/CB_M5_second.txt",
        ],
    ),
]
...
def process_file(file_name, w0):
    ...
    with open(file_name, "r") as file:
        ...
        if len(lines) < 3:  # Make sure there are at least 3 lines in the file
            print(
                f"Warning: {file_name} does not have enough lines. Skipping this file."
            )
            return values, errors

        # Determine the line to process
        line_idx = (
            1 if file_name.startswith("CB_") else 2
        )  # Second line for 'CB_' files, third line otherwise

        # Make sure the chosen line exists
        if line_idx >= len(lines):
            print(
                f"Warning: {file_name} does not have enough lines for line index {line_idx}. Skipping this file."
            )
            return values, errors
        ...
        sys = max(
            abs(measurements[i] - measurements[j])
...
cb_colors = [
    cm.RdBu(i) for i in np.linspace(0, 0.3, 6)
]  # Use a range from the RdBu colormap
